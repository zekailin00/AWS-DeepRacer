...
def main(argv=sys.argv[1:]):
    ...
    web_server_action = ExecuteProcess(
        cmd=['/root/deepracer_ws/aws-deepracer-launcher/build/async_web_server_cpp/test/test_web_server'])
    ld.add_action(web_server_action)

    test_directory = '/root/deepracer_ws/aws-deepracer-launcher/async_web_server_cpp/test'
