...
: ${AMENT_CURRENT_PREFIX:="/root/deepracer_ws/aws-deepracer-launcher/install/deepracer_launcher"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/deepracer_launcher/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/deepracer_launcher/environment/path.sh"
