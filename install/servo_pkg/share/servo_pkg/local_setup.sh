...
: ${AMENT_CURRENT_PREFIX:="/root/deepracer_ws/aws-deepracer-launcher/install/servo_pkg"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/servo_pkg/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/servo_pkg/environment/path.sh"
